 ...
 * link), and is a silent no-op otherwise (a published tarball, where `src/`
 * is excluded from `files` and `lib/client.js` is pre-built). This keeps
 * `npm install` working in both contexts without shipping the build inputs

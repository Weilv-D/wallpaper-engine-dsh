 ...
 *
 * Emits the exact artifact shape the DSH client module loader consumes — the
 * same envelope `tsdown` emits for in-box client packages:
 *
 ...
 * deterministic, dependency-free stand-in for a bundler, which keeps the
 * out-of-tree package buildable with plain Node.
 *
...
// Header comments are preserved inside the factory (harmless), but strip the
// leading "this is the canonical source" banner so the emitted bundle reads
